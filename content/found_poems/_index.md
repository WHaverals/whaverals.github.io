...
TODO: A longer write-up of the data, the filters, and the methods is in preparation; for now, the map itself is the argument → **[Open the interactive map](https://whaverals.github.io/found_poems/found_poems.html)**.

For a network visualization of the actual *poets* that are being co-cited in the PPA, see [this map](https://whaverals.github.io/ppa_poets/).
